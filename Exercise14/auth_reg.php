...
8. Написать обработчик выхода, который будет срабатывать при переходе по определённой ссылке и удалять из сессии id пользователя.

9. В index.php в завивимости от наличия в сесии id пользователя выдаём:
	Если id нет: ссылку на регистрацию, ссылку на авторизацию (или форму авторизации и ссылку на регистрацию)
	Если id есть: Добрый день/вечер.., уважаемый, Имя. До вашего дня рождения осталось дней: 23. Ссылка на выход.